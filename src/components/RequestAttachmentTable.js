...
import styles from './RequestAttachmentTable.css';
...
const L = language.RequestDetails.RequestAttachmentTable;
class RequestAttachmentTable extends React.Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    return (
      <div
        className={styles.requestAttachmentContainer}
        style={{
...
export default RequestAttachmentTable;
