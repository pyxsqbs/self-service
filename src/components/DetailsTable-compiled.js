...
var _DetailsTable = require('./DetailsTable.css');
...
var DetailsTable = function (_React$Component) {
  _inherits(DetailsTable, _React$Component);

  function DetailsTable(props) {
    _classCallCheck(this, DetailsTable);

    var _this = _possibleConstructorReturn(this, (DetailsTable.__proto__ || Object.getPrototypeOf(DetailsTable)).call(this, props));
    ...
    value: function render() {
      ...
      var theadItems = this.state.columns.map(function (x, index) {
        return _react2.default.createElement(
          'div',
          { className: _DetailsTable2.default.theadTh, key: x.key,
      ...
      var tbodyItems = this.state.data.map(function (x) {
        return _react2.default.createElement(
          'div',
          { className: _DetailsTable2.default.tbodyTrContainer, key: x.key },
          _react2.default.createElement(
            'div',
            {
              className: _DetailsTable2.default.tbodyTr,
            ...
            _this2.state.columns.map(function (y, index) {
              return _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'div',
                  { className: _DetailsTable2.default.tbodyTh,
                    style: {
                      width: _this2.state.columnsWidth[index] ? _this2.state.columnsWidth[index] + 1 : undefined,
      ...
      return _react2.default.createElement(
        'div',
        { className: _DetailsTable2.default.detailsTableContainer },
        _react2.default.createElement(
          'div',
          { className: _DetailsTable2.default.tableCanvas },
          _react2.default.createElement(
            'div',
            { className: _DetailsTable2.default.theadStyle, style: { borderBottom: this.state.borderBottom },
              id: this.props.tid + 'thead' },
            _react2.default.createElement(
              'div',
              { className: _DetailsTable2.default.theadTr, style: { paddingBottom: this.state.paddingBottom } },
              theadItems
            )
          ),
          _react2.default.createElement(
            'div',
            { className: _DetailsTable2.default.tbodyStyle, id: this.props.tid + 'tbody' },
            tbodyItems
          ),
          _react2.default.createElement(
            'div',
            {
              ...
              className: _DetailsTable2.default.tableNodata
            },
            _react2.default.createElement('div', { className: _DetailsTable2.default.icInfo }),
            L.icInfo
          )
        )
      );
...
//# sourceMappingURL=DetailsTable-compiled.js.map